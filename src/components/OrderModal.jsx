    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative w-full max-w-3xl bg-white h-full shadow-2xl border-l border-slate-200 flex flex-col animate-in slide-in-from-right duration-300">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="col-span-1 md:col-span-2">
                ...
                <input disabled={isEmployeeEditing} required type="text" placeholder="Entity Name" value={formData.customer} onChange={(e) => setFormData({ ...formData, customer: e.target.value })} className={inputBase} />
              </div>
              <div>
              ...
              <div>
                ...
                <input disabled={isEmployeeEditing} required type="text" placeholder="e.g. INV-2026-001" value={formData.invoiceNo} onChange={(e) => setFormData({ ...formData, invoiceNo: e.target.value })} className={`${inputBase} font-mono`} />
              </div>
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-1">Invoice Date *</label>
                <div className="relative">
                  <Calendar size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400" />
                  <input disabled={isEmployeeEditing} required type="date" value={formData.invoiceDate} onChange={(e) => setFormData({ ...formData, invoiceDate: e.target.value })} className={iconInputBase} />
                </div>
              </div>
            </div>
          </section>
                  ...
                  {AVAILABLE_PRODUCTS.map(prod => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-md text-sm font-semibold transition-all border ${isSelected
        ...
        <div className="px-6 py-4 border-t border-slate-200 bg-slate-50 flex items-center justify-end gap-3 shrink-0 z-10">
          ...
          {/* Changed to type="submit" and form="order-form" */}
          <button
            type="submit"
            form="order-form"
